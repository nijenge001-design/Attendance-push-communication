...
use App\Policies\Api\v1\AttendanceLogPolicy;
...
#[UsePolicy(AttendanceLogPolicy::class)]
#[Fillable(['device_serial', 'pin', 'timestamp', 'status', 'verify_mode', 'workcode', 'reserved1', 'reserved2', 'id_number', 'type', 'mask_flag', 'temperature', 'conv_temperature'])]
