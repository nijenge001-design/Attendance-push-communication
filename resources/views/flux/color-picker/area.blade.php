...
<div {{ $attributes->class($classes) }} data-flux-color-picker-area>
    ...
    <div class="absolute inset-0 rounded-lg overflow-hidden bg-gradient-to-r from-white to-transparent rtl:-scale-x-100" data-flux-color-picker-area-gradient></div>
    ...
    <div
        ...
        class="absolute size-5 sm:size-4 rounded-full border-2 border-white shadow-[0_0_0_1px_rgba(0,0,0,.15)] -translate-x-1/2 -translate-y-1/2 rtl:translate-x-1/2 pointer-events-none outline-offset-2"
        tabindex="0"
        role="slider"
